# ChatGPT custom GPT (hosted runtime): signs a Nano block inside, persists seed material only in editor-visible Instructions, and needs a human click per outbound call only while the Action is declared consequential; a ChatGPT scheduled task could not reach the Action at all (revised 2026-09-18 00:30 UTC)
